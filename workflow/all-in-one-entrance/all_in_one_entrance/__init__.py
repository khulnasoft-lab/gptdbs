...
from gptdb.core.awel import DAG, JoinOperator, MapOperator, is_empty_data
from gptdb.core.awel.flow import IOField, OperatorCategory, ViewMetadata
from gptdb.core.awel.trigger.http_trigger import (
    CommonLLMHttpRequestBody,
    CommonLLMHttpTrigger,
)
from gptdb.core.interface.operators.llm_operator import BaseLLM
from gptdb.core.operators import BaseConversationOperator
from gptdb.experimental.intent.base import IntentDetectionResponse
from gptdb.experimental.intent.operators import (
...
with DAG("gptdbs_all_in_one_entrance_intent_detection_dag") as dag:
    trigger = CommonLLMHttpTrigger(
        "/gptdbs/all-in-one-entrance",
        methods="POST",
