...
from gptdb.core.awel.trigger.http_trigger import HttpTrigger
...
from gptdb.rag.embedding import EmbeddingFactory, Embeddings
...
class RAGMixin(BaseOperator, ABC):
    ...
    async def get_embeddings(
        ...
        from gptdb.configs.model_config import EMBEDDING_MODEL_CONFIG, get_device
...
with DAG(
    ...
    trigger = HttpTrigger(
        "/gptdbs/fin_knowledge_process", methods="POST", request_body=TriggerReqBody
    )
