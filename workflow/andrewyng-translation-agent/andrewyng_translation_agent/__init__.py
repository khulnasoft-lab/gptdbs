...
from gptdb.model.operators import MixinLLMOperator
from gptdb.rag.text_splitter.text_splitter import RecursiveCharacterTextSplitter
...
async def _translate(
    ...
    """
    from gptdb.core.awel import InputSource, InputOperator
...
with DAG("andrewyng_translation_agent_dag") as dag:
    ...
    trigger = CommonLLMHttpTrigger(
        "/gptdbs/andrewyng_translation_agent_dag",
        methods="POST",
